...
> = {
  ...
  meta: {
    modelProps: 'user' | 'session' | 'account' | 'verification' | 'rateLimit' | 'setupState';
...
export type SetupStateScalarFieldEnum =
  (typeof SetupStateScalarFieldEnum)[keyof typeof SetupStateScalarFieldEnum];
